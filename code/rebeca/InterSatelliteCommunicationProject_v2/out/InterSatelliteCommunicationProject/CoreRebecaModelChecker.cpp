	...
	switch (propertySelector) {
		case 1:
			switch(claim) {
				...
				case 0:
							result.push_back(0);
							if (_ref_s1GroundSlot&_ref_s2GroundSlot) result.push_back(1);
							if (_ref_s1GroundSlot&_ref_s3GroundSlot) result.push_back(1);
							if (_ref_s2GroundSlot&_ref_s3GroundSlot) result.push_back(1);
					break;
			}
		break;
		case 2:
			switch(claim) {
				...
				case 0:
							result.push_back(0);
							if (_ref_s1ActualGroundSend&!_ref_s1EnergyOK) result.push_back(1);
							if (_ref_s1ActualSendToS2&!_ref_s1EnergyOK) result.push_back(1);
							if (_ref_s1ActualSendToS3&!_ref_s1EnergyOK) result.push_back(1);
							if (_ref_s2ActualGroundSend&!_ref_s2EnergyOK) result.push_back(1);
							if (_ref_s2ActualSendToS3&!_ref_s2EnergyOK) result.push_back(1);
							if (_ref_s3ActualGroundSend&!_ref_s3EnergyOK) result.push_back(1);
					break;
			}
		break;
		case 3:
			switch(claim) {
				case 1:
					...
					break;
				case 0:
							if (!_ref_s1BufOK) result.push_back(1);
							if (!_ref_s2BufOK) result.push_back(1);
							if (!_ref_s3BufOK) result.push_back(1);
							result.push_back(0);
					break;
			}
		break;
		case 4:
			switch(claim) {
				case 1:
							if (_ref_s1Pending&!_ref_s1DeliveredToGS&!_ref_s1Dropped) result.push_back(1);
					break;
				case 2:
							if (_ref_s2Pending&!_ref_s2DeliveredToGS&!_ref_s2Dropped) result.push_back(2);
					break;
				case 3:
							if (_ref_s3Pending&!_ref_s3DeliveredToGS&!_ref_s3Dropped) result.push_back(3);
					break;
				case 0:
							result.push_back(0);
							if (_ref_s1Pending&!_ref_s1DeliveredToGS&!_ref_s1Dropped) result.push_back(1);
		...
		case 5:
			switch(claim) {
				case 1:
							if (!_ref_s1GroundSlot) result.push_back(1);
					break;
				case 2:
							if (!_ref_s2GroundSlot) result.push_back(2);
					break;
				case 3:
							if (!_ref_s3GroundSlot) result.push_back(3);
					break;
				case 0:
							if (!_ref_s1GroundSlot) result.push_back(1);
							if (!_ref_s2GroundSlot) result.push_back(2);
...
void CoreRebecaModelChecker::doDFSModelChecking(string userSelectedPropertyName, string userSelectedPropertyType) {
	...
	if (userSelectedPropertyName.empty())
		propertySelector = 0;
		else if (userSelectedPropertyName == "NoGroundInterference") {
			propertySelector = 1;
				claim = 0;
		}
		else if (userSelectedPropertyName == "NoSendLowEnergy") {
			propertySelector = 2;
				claim = 0;
		}
		else if (userSelectedPropertyName == "NoBufferOverflow") {
			propertySelector = 3;
				claim = 0;
		}
		else if (userSelectedPropertyName == "EventualProcessing") {
			propertySelector = 4;
				claim = 0;
		}
		else if (userSelectedPropertyName == "PeriodicGroundAccess") {
			propertySelector = 5;
				claim = 0;
		}
	else {
