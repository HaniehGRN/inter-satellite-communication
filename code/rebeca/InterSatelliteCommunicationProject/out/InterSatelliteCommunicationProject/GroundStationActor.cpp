...
#define _RETURN_ return 0
    long GroundStationActor::constructorGroundStation (byte creatorId 
		...
		{
			(_ref_messageCount[(arrayIndexChecker=0, assertion(arrayIndexChecker >= 0 && arrayIndexChecker <3, string("Array index out of bound: ") + to_string((long long)arrayIndexChecker) + ", method \"" + reactiveClassName + "." + methodName + "\" line 7") , arrayIndexChecker)]=0);
			(_ref_messageCount[(arrayIndexChecker=1, assertion(arrayIndexChecker >= 0 && arrayIndexChecker <3, string("Array index out of bound: ") + to_string((long long)arrayIndexChecker) + ", method \"" + reactiveClassName + "." + methodName + "\" line 8") , arrayIndexChecker)]=0);
			(_ref_messageCount[(arrayIndexChecker=2, assertion(arrayIndexChecker >= 0 && arrayIndexChecker <3, string("Array index out of bound: ") + to_string((long long)arrayIndexChecker) + ", method \"" + reactiveClassName + "." + methodName + "\" line 9") , arrayIndexChecker)]=0);
		}
		shift = 0;
		queueTail = 0;
...
, TIME_TYPE executionTime, TIME_TYPE deadline){
	...
	#define _RETURN_ goto _RETURN_POINT_RECEIVEFROMSATELLITE
		...
		{
			if ((_ref_satId==1)) {
				(_ref_messageCount[(arrayIndexChecker=0, assertion(arrayIndexChecker >= 0 && arrayIndexChecker <3, string("Array index out of bound: ") + to_string((long long)arrayIndexChecker) + ", method \"" + reactiveClassName + "." + methodName + "\" line 13") , arrayIndexChecker)]=(_ref_messageCount[(arrayIndexChecker=0, assertion(arrayIndexChecker >= 0 && arrayIndexChecker <3, string("Array index out of bound: ") + to_string((long long)arrayIndexChecker) + ", method \"" + reactiveClassName + "." + methodName + "\" line 13") , arrayIndexChecker)]+1));}
			if ((_ref_satId==2)) {
				(_ref_messageCount[(arrayIndexChecker=1, assertion(arrayIndexChecker >= 0 && arrayIndexChecker <3, string("Array index out of bound: ") + to_string((long long)arrayIndexChecker) + ", method \"" + reactiveClassName + "." + methodName + "\" line 14") , arrayIndexChecker)]=(_ref_messageCount[(arrayIndexChecker=1, assertion(arrayIndexChecker >= 0 && arrayIndexChecker <3, string("Array index out of bound: ") + to_string((long long)arrayIndexChecker) + ", method \"" + reactiveClassName + "." + methodName + "\" line 14") , arrayIndexChecker)]+1));}
			if ((_ref_satId==3)) {
				(_ref_messageCount[(arrayIndexChecker=2, assertion(arrayIndexChecker >= 0 && arrayIndexChecker <3, string("Array index out of bound: ") + to_string((long long)arrayIndexChecker) + ", method \"" + reactiveClassName + "." + methodName + "\" line 15") , arrayIndexChecker)]=(_ref_messageCount[(arrayIndexChecker=2, assertion(arrayIndexChecker >= 0 && arrayIndexChecker <3, string("Array index out of bound: ") + to_string((long long)arrayIndexChecker) + ", method \"" + reactiveClassName + "." + methodName + "\" line 15") , arrayIndexChecker)]+1));}
		}
