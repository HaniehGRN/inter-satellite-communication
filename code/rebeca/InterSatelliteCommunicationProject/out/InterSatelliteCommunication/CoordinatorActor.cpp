...
#define _RETURN_ return 0
    long CoordinatorActor::constructorCoordinator (byte creatorId 
		...
		{
			(_ref_slot=0);
			(temp0=_ref_self, assertion(temp0!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 167"), temp0)->_timed_msg_nextSlot(myID, _ref_now, MAX_TIME);
		}
		shift = 0;
		queueTail = 0;
...
, TIME_TYPE executionTime, TIME_TYPE deadline){
	...
	#define _RETURN_ goto _RETURN_POINT_NEXTSLOT
		...
		{
			if ((_ref_slot==0)) {
				(temp0=_ref_s1, assertion(temp0!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 175"), temp0)->_timed_msg_grantGround(myID, _ref_now, MAX_TIME);}
			else {
				if ((_ref_slot==1)) {
					(temp1=_ref_s2, assertion(temp1!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 176"), temp1)->_timed_msg_grantGround(myID, _ref_now, MAX_TIME);}
				else {
					if ((_ref_slot==2)) {
						(temp2=_ref_s3, assertion(temp2!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 177"), temp2)->_timed_msg_grantGround(myID, _ref_now, MAX_TIME);}
					else {
						if ((_ref_slot==3)) {
							{
							}
							...
							if ((_ref_slot==4)) {
								(temp3=_ref_s1, assertion(temp3!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 184"), temp3)->_timed_msg_grantISL(myID, _ref_s2, _ref_now, MAX_TIME);}
							else {
								if ((_ref_slot==5)) {
									(temp4=_ref_s2, assertion(temp4!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 185"), temp4)->_timed_msg_grantISL(myID, _ref_s3, _ref_now, MAX_TIME);}
								else {
									if ((_ref_slot==6)) {
										(temp5=_ref_s1, assertion(temp5!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 186"), temp5)->_timed_msg_grantISL(myID, _ref_s3, _ref_now, MAX_TIME);}
									else {
										if ((_ref_slot==7)) {
											{
											}
			...
			(temp6=_ref_self, assertion(temp6!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 196"), temp6)->_timed_msg_nextSlot(myID, 1 + _ref_now, MAX_TIME);
		}
