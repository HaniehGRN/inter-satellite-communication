#include "AbstractTimedRebecaAnalyzer.h"
		...
		#define _ref_s1 (dynamic_cast<SatelliteActor*>(rebecs[1]))
		#define _ref_s2 (dynamic_cast<SatelliteActor*>(rebecs[2]))
		#define _ref_s3 (dynamic_cast<SatelliteActor*>(rebecs[3]))
		#define _ref_coord (dynamic_cast<CoordinatorActor*>(rebecs[4]))
...
void AbstractTimedRebecaAnalyzer::instantiationPart() {
	...
	byte maxRebecID = 0;
    	...
    	SatelliteActor* _ref_s1 = new SatelliteActor(maxRebecID++, "s1", 10, 12, *referenceToRebecs 
    											#ifdef DEBUG_LEVEL_2 
    											, analysisOutputStream 
    											#endif
    											, 228
    	...
    	SatelliteActor* _ref_s2 = new SatelliteActor(maxRebecID++, "s2", 10, 12, *referenceToRebecs 
    											#ifdef DEBUG_LEVEL_2 
    											, analysisOutputStream 
    											#endif
    											, 228
    	...
    	SatelliteActor* _ref_s3 = new SatelliteActor(maxRebecID++, "s3", 10, 12, *referenceToRebecs 
    											#ifdef DEBUG_LEVEL_2 
    											, analysisOutputStream 
    											#endif
    											, 228
